...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/ailab/Project/04_HMG_AVC/OpenPCDet/output/argo2_models/voxel04_pointpillar_v2/default/ckpt/checkpoint_epoch_73.pth',
