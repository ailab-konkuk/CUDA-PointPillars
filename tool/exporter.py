...
def main():
    ...
    with torch.no_grad():
      ...
      torch.onnx.export(model,       # model being run
          ...
          "./kitti_raw.onnx",  # where to save the model (can be a file or file-like object)
      ...
      onnx_raw = onnx.load("./kitti_raw.onnx")  # load onnx model
      ...
      onnx.save(onnx_final, "kitti.onnx")
